...
-- открыть две сессии sql shell (psql) - или два терминала psql

-- в первой сессии ввести:
BEGIN;
UPDATE pizzeria SET rating = 5.0 WHERE name = 'Pizza Hut';

-- Далее в обоих сессиях ввести:
SELECT * FROM pizzeria WHERE name = 'Pizza Hut';

-- Результат получится как на скриншоте ex00_0
-- в первой сессии будут видны изменения, а во второй нет

-- Далее в первой сессии (где был BEGIN;) ввести
COMMIT;

-- Далее в обоих сессиях ввести:
SELECT * FROM pizzeria WHERE name = 'Pizza Hut';

-- Результат получится как на скриншоте ex00_1
